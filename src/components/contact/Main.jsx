...
const Main = () => {
    ...
    return (
        <main className="w-full h-full text-white relative">
            <div className="container px-32 flex mx-auto relative py-20 justify-between">
                ...
                <div className='w-1/2 bg-[#FFFFFF]/[.05] z-10 rounded-lg p-16 shadow-lg'>
                    <div className='w-full'>
                        <h3 className='font-semibold text-[18px] font-clash text-purp'>Questions or need assistance?</h3>
